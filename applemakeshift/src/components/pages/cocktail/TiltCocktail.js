...
import Tiltcocktail from '../../images/products/CocktailTilt.png'
    ...
    return (
        <div class="w-screen-xl font-lato">
            ...
            <div class="m-auto pt-10 text-center">
                <span class="text-orange-400 text-md md:text-lg font-bold"> #1 Best Seller </span>
                <p class="font-bold text-4xl md:text-5xl mt-2"> Tilt-Screen Cocktail </p>
                <p class="mb-4 md:mb-6 font-bold text-xl md:text-2xl"> 3 Sided Arcade Machine. </p>
                <p> From $2598 </p>
                <div class="flex pb-6">
                ...
                <img class="m-auto w-96 h-96 p-4 md:p-0" src={Tiltcocktail} alt="3 Sided Tilt Cocktail" />
            </div>
        </div>
    );
}