...
export default function Comparison() {
  return (
    <div class="font-lato m-auto pb-10 sm:pb-20 items-center w-screen sm:max-w-screen-xl">
      ...
      <div class="p-2 md:p-0 md:w-4/12 place-items-center justify-center m-auto grid md:gap-72 grid-cols-1 lg:grid-cols-3 text-center">
        <div class="pt-0 md:pt-16 md:w-52">
          <img
            class="w-44 h-44 m-auto"
            src={TR2Pinball}
            alt="3 Sided Tilt Screen Cocktail"
          />
        ...
        <div class="pt-16 md:w-52">
          <img
            class="w-44 h-44 m-auto"
            src={ComboPinball7403}
            alt="Combo Pinball 7403"
          />
