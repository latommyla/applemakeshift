...
import MidSize from '../../images/products/MidSizeBarrel.png'

export default function MidSizeBarrel() {
    return (
        <div class="w-screen-xl font-lato">
            ...
            <div class="m-auto pt-10 text-center">
                ...
                <p class="font-bold text-4xl md:text-5xl mt-2"> Wine Barrel </p>
                <p class="mb-4 md:mb-6 font-bold text-xl md:text-2xl"> Mid Size. </p>
                <p> From $1799 </p>
                <div class="flex pb-6">
                ...
                <img class="m-auto w-96 h-96 p-4 md:p-0" src={MidSize} alt="Mid Size Wine Barrel Arcade" />
            </div>
        </div>
    );
}