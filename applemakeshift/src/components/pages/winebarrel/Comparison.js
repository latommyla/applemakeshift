        ...
        <div class="font-lato m-auto pb-10 sm:pb-20 items-center w-screen sm:max-w-screen-xl">
            ...
            <div class="p-2 md:p-0 md:w-4/12 place-items-center justify-center m-auto grid md:gap-64 grid-cols-2 sm:grid-cols-4 text-center">
                <div class="pt-0 md:pt-16 md:w-52">
                    <img class="w-32 h-32 md:w-44 md:h-44 m-auto" src={ XLWine } alt="XL Wine Barrel Arcade" />
                ...
                <div class="pt-0 md:pt-16 md:w-52">
                    <img class="w-32 h-32 md:w-44 md:h-44 m-auto" src={ WineBarrel24 } alt="24 Inch Wine Barrel Arcade" />
                ...
                <div class="pt-14 md:pt-16 md:w-52">
                    <img class="w-32 h-32 md:w-44 md:h-44 m-auto" src={ WineBarrel19 } alt="19 Inch Wine Barrel Arcade" />
                ...
                <div class="pt-14 md:pt-16 md:w-52">
                    <img class="w-32 h-32 md:w-44 md:h-44 m-auto" src={ WineBarrel17 } alt="17 Inch Wine Barrel Arcade" />
