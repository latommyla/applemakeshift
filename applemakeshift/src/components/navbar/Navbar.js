...
export default function Navbartest() {
    return (
        <Navbar fluid={true} class="bg-[#323233] h-11 sm:m-auto fixed w-screen z-10">
            ...
            <div class="container relative flex flex-wrap items-center justify-center mx-auto">
                <div class="flex sm:flex-none sm:m-0 w-screen items-center sm:w-fit">
                    <div class="m-auto">
                        <a href="/">
                            <img src={Logo} class="h-10 sm:mr-10 ml-8" alt="Creative Arcades Logo" />
                        </a>
                    </div>
                    <div class="sm:hidden mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#D1D5DB" class="bi bi-bag hover:fill-white" viewBox="0 0 16 16">
